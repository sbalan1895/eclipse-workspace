...
@Test ()
  	public void NewInvoiceMiscCreate() throws InterruptedException, IOException {
	...
	// TODO Auto-generated method stub
		...
		vendorDropdown.selectByVisibleText("HP Communications");
		...
		invoiceNumberElement.sendKeys("AutoMisc" + invoiceNumber.substring(2, 16));
		...
		Select invoiceServiceElement = new Select(driver.findElement(By.name("cmbCustInvoiceSetup8")));
