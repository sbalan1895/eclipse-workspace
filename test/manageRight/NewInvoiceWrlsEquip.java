...
public class NewInvoiceWrlsEquip {
	WebDriver driver;
	WebDriverWait wait;
...
@Test ()
  	public void NewInvoiceWrlsEquipCreate() throws InterruptedException, IOException {
	...
	// TODO Auto-generated method stub
		...
		vendorDropdown.selectByVisibleText("Cellular Accessories For Less");
		...
		invoiceNumberElement.sendKeys("AutoWrlsEquip" + invoiceNumber.substring(2, 16));
		...
		Select invoiceServiceElement = new Select(driver.findElement(By.name("cmbCustInvoiceSetup18")));
