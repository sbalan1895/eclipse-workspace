...
@Test ()
  	public void NewInvoicePLCreate() throws InterruptedException, IOException {
	...
	// TODO Auto-generated method stub
		...
		invoiceNumberElement.sendKeys("AutoPL" + invoiceNumber.substring(2, 16));
		...
		Select invoiceServiceElement = new Select(driver.findElement(By.name("cmbCustInvoiceSetup2")));
