...
public class NewInvoiceDedicatedAccessDDT {
	WebDriver driver;
	WebDriverWait wait;
...
@Test (dataProvider = "NewInvoiceData")
  	public void NewInvoiceDACreateDDT(String vendor, String	vendorAddress, String accountNumber, String	invoiceNumber, String invoiceDate, String dueDate, String totalAmountDue, String currentCharges, String serviceMap
	...
	// TODO Auto-generated method stub
		...
		Select invoiceServiceElement = new Select(driver.findElement(By.name("cmbCustInvoiceSetup3")));
