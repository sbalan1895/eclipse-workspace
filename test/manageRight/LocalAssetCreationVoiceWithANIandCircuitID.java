...
public class LocalAssetCreationVoiceWithANIandCircuitID {
	WebDriver driver;
	WebDriverWait wait;
...
@Test
  	public void LocalAssetCreateANICircuitID() throws InterruptedException, IOException {
...
//Mandatory fields- Circuit ID or ANI, Line type, Service location
		...
		String uniqueID = "AutoLocal" + assetID.substring(0, 17);
