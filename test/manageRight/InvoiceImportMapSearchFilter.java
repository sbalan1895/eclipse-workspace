...
public class InvoiceImportMapSearchFilter {
	WebDriver driver;
	WebDriverWait wait;
...
public void SearchByMapType() throws InterruptedException {
	...
	Thread.sleep(2000);
	List <WebElement> searchResult = driver.findElements(By.xpath("//tr"));
...
@BeforeClass
	  public void beforeClass() throws InterruptedException, IOException {
		...
		WebElement setupLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Setup')]")));
		
		setupLink.click();
		
		WebElement invoiceMapLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='#'][contains(text(),'Invoice Maps')]")));
		
		invoiceMapLink.click(); 
		
		WebElement allInvoicesLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(text(),'All Invoice Maps')]")));
