...
public class EquipmentAssetCreationLease {
	WebDriver driver;
	WebDriverWait wait;
...
@Test
  	public void EquipmentAssetCreateLease() throws InterruptedException, IOException {
	...
	private void newEquipmentAssetDetailEntry() throws InterruptedException {
		...
		String uniqueID = "AutoEquipLease" + assetID.substring(0, 17);
		...
		buyOrLease.selectByValue("2");
		WebElement leaseTerm = driver.findElement(By.name("dfLeaseTerm"));
		leaseTerm.sendKeys("12");
		saveAsset.click();
