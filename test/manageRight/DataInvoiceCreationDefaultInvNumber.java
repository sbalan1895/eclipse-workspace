...
public class DataInvoiceCreationDefaultInvNumber {
	WebDriver driver;
	WebDriverWait wait;
...
@Test
  	public void internetInvoiceCreation() throws InterruptedException, IOException {
		...
		internetInvoiceCreate(); //create new invoice method
	  
	}
private void internetInvoiceCreate() throws InterruptedException {
	// TODO Auto-generated method stub
		...
		output = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("cmbCustInvoiceSetup10")));
...
@Test
	public void privateLineInvoiceCreation() throws InterruptedException, IOException {
	...
	privateLineInvoiceCreate(); //create new invoice method
  
}
private void privateLineInvoiceCreate() throws InterruptedException {
// TODO Auto-generated method stub
	String parentWindowHandle = driver.getWindowHandle(); 
	...
	vendorDropdown.selectByVisibleText("AtLink Services");
	Thread.sleep(1000);
	...
	output = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("cmbCustInvoiceSetup2")));
	Select invoiceService = new Select(driver.findElement(By.name("cmbCustInvoiceSetup2")));
	invoiceService.selectByIndex(1); 	//.selectByValue("Internet RPI") OR selectByVisibleText("Internet RPI");
...
@Test
	public void mplsInvoiceCreation() throws InterruptedException, IOException {
	...
	mplsInvoiceCreate(); //create new invoice method
  
}
private void mplsInvoiceCreate() throws InterruptedException {
// TODO Auto-generated method stub
	String parentWindowHandle = driver.getWindowHandle(); 
	...
	output = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("cmbCustInvoiceSetup16")));
	Select invoiceService = new Select(driver.findElement(By.name("cmbCustInvoiceSetup16")));
	invoiceService.selectByIndex(1); 	//.selectByValue("Internet RPI") OR selectByVisibleText("Internet RPI");
...
@Test
	public void accessInvoiceCreation() throws InterruptedException, IOException {
	...
	accessInvoiceCreate(); //create new invoice method
  
}
private void accessInvoiceCreate() throws InterruptedException {
// TODO Auto-generated method stub
	String parentWindowHandle = driver.getWindowHandle();
	...
	output = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("cmbCustInvoiceSetup3")));	
	Select invoiceService = new Select(driver.findElement(By.name("cmbCustInvoiceSetup3")));
	invoiceService.selectByIndex(1); 	//.selectByValue("Internet RPI") OR selectByVisibleText("Internet RPI");
