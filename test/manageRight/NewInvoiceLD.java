...
@Test ()
  	public void NewInvoiceLDCreate() throws InterruptedException, IOException {
	...
	// TODO Auto-generated method stub
		...
		vendorDropdown.selectByVisibleText("CenturyLink");
		...
		invoiceNumberElement.sendKeys("AutoLD" + invoiceNumber.substring(2, 16));
		...
		Select invoiceServiceElement = new Select(driver.findElement(By.name("cmbCustInvoiceSetup1")));
