...
@Test ()
  	public void NewInvoiceWrlsCreate() throws InterruptedException, IOException {
	...
	// TODO Auto-generated method stub
		...
		vendorDropdown.selectByVisibleText("GlobalStar");
		...
		invoiceNumberElement.sendKeys("AutoWrls" + invoiceNumber.substring(2, 16));
		...
		Select invoiceServiceElement = new Select(driver.findElement(By.name("cmbCustInvoiceSetup7")));
