...
public class OrderSearchbyType {
	WebDriver driver;
	WebDriverWait wait;
...
@DataProvider (name="SearchOrderTypeData")
	public Object[][] orderDataProviderMethod() {
	    Object[][] retObjArr=getDataFromXLSUsingJXL("\\home\\deepalimehroliya\\IdeaProjects\\automated_tests\\test\\resources\\data\\SearchOrderType.xls",
	            "OrderNum", "StartAndEnd");
	      return(retObjArr);	  
	}
@Test ()
  	public void OrderSearchType() throws InterruptedException, IOException {
	...
	// TODO Auto-generated method stub
		...
		try {
			...
			orderType.selectByValue("1"); //as per data excel
