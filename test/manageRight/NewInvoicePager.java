...
@Test ()
  	public void NewInvoicePagerCreate() throws InterruptedException, IOException {
	...
	// TODO Auto-generated method stub
		...
		invoiceNumberElement.sendKeys("AutoPager" + invoiceNumber.substring(2, 16));
		...
		Select invoiceServiceElement = new Select(driver.findElement(By.name("cmbCustInvoiceSetup17")));
