...
public class NewInvoiceConferencing {
	WebDriver driver;
	WebDriverWait wait;
...
@Test
  	public void NewInvoiceConferencingCreate() throws InterruptedException, IOException {
	...
	// TODO Auto-generated method stub
		...
		invoiceNumberElement.sendKeys("AutoConf" + invoiceNumber.substring(2, 16));
		...
		Select invoiceServiceElement = new Select(driver.findElement(By.name("cmbCustInvoiceSetup11")));
