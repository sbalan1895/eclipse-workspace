...
public class NewInvoiceLocalDDT {
	WebDriver driver;
	WebDriverWait wait;
...
@DataProvider (name="NewInvoiceData")
	public Object[][] invoiceDataProviderMethod() {
	    Object[][] retObjArr=getDataFromXLSUsingJXL("test\\resources\\data\\NewInvoicesLocal.xls",
	            "NewInvoice", "StartAndEnd");
	      return(retObjArr);	  
	}
	
@Test (dataProvider = "NewInvoiceData")
  	public void NewInvoiceLocalCreateDDT(String vendor, String	vendorAddress, String accountNumber, String	invoiceNumber, String invoiceDate, String dueDate, String totalAmountDue, String currentCharges, String serviceMap
	...
	// TODO Auto-generated method stub
		...
		Select invoiceServiceElement = new Select(driver.findElement(By.name("cmbCustInvoiceSetup0")));
		invoiceServiceElement.selectByIndex(0);; 	
